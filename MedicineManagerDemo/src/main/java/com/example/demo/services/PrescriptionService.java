...
public class PrescriptionService {
	...
	public void sendPatientTextForPickup(Prescription prescription) {
		...
		String phoneNumber = prescription.getPrescriptionPatient().getPhoneNumber();
	    	...
	    	MessageCreator msgCreator = Message.creator(new PhoneNumber(phoneNumber), new PhoneNumber(TWILIO_NUMBER), "Hi "+ patientName + ", Your prescription is ready for pickup in " + PharmacyName + ".");	
	...
	public void sendPatientTextCancelled(Prescription prescriptionStored) {
		...
		String phoneNumber = prescriptionStored.getPrescriptionPatient().getPhoneNumber();
	    	...
	    	MessageCreator msgCreator = Message.creator(new PhoneNumber(phoneNumber), new PhoneNumber(TWILIO_NUMBER), "Hi "+ patientName + ", Unfortunately Your prescription has been cancelled by" + PharmacyName + ".");	
